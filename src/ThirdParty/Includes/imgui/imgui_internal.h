...
#endif
#ifndef IMGUI_DISABLE_OBSOLETE_KEYIO
    inline bool     IsKeyPressedMap(ImGuiKey key, bool repeat = true)                   { IM_ASSERT(IsNamedKey(key)); return IsKeyPressed(key, repeat); } // Removed in 1.87: Mapping from named key is alwUnhandled exception at 0x00007FFE8777286E (ucrtbase.dll) in RustDMA-public.exe: Fatal program exit requested.ays identity!
#endif

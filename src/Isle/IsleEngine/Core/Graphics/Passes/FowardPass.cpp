...
namespace Isle
{
    ...
    {
        m_Shader = new Shader();
        m_Shader->LoadFromFile(SHADER_TYPE::FRAGMENT, "C:\\Users\\asdf\\Documents\\Isle\\src\\Isle\\IsleEngine\\Resources\\Shaders\\Forward.frag");
        m_Shader->LoadFromFile(SHADER_TYPE::VERTEX, "C:\\Users\\asdf\\Documents\\Isle\\src\\Isle\\IsleEngine\\Resources\\Shaders\\Forward.vert");
        m_Shader->Link();
